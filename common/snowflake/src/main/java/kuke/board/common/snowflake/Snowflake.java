...
public class Snowflake {
	...
	private static final int EPOCH_BITS = 41; // 41비트로 순차성 보장
	private static final int NODE_ID_BITS = 10; // 10비트로 노드 아이디 할당
	private static final int SEQUENCE_BITS = 12; // 12비트로 시퀀스 할당
